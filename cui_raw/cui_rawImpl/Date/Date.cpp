/*
** Date.cpp - date control implementation
**
** cui framework
...
LRESULT CALLBACK cui_rawImpl::DateControlProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	LONG_PTR ptr = GetWindowLongPtr(hWnd, GWLP_USERDATA);
	cui_rawImpl::DateControl* pThis = reinterpret_cast<cui_rawImpl::DateControl*>(ptr);
